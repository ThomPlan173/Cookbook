...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 31 mars 2023 à 13:16
...
CREATE TABLE IF NOT EXISTS `contenir` (
  ...
  `unite` enum('CàC','CàS','mL','L','g') DEFAULT NULL,
  KEY `idRecette` (`idRecette`),
